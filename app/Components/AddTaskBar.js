...
function AddTaskBar(props) {
    ...
    return toast.success('The task (${addTaskText}) is added succesfully');
  ...
  return (
    <div className='flex justify-between p-3 mt-5'>
        ...
        <button className='bg-gradient-to-r text-white rounded-md w-[120px] from-blue-700 to-blue-400 hover:text-black hover:text-light'>Add a task</button>
    </div>
  )
}
